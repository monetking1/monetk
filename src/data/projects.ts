...
import thePerfectPitchImage from '../assets/images/the-perfect-pitch.jpg';
...
export const projects: Project[] = [
    {
        ...
        title: 'New Hire Onboarding Tracker & Dashboard Client',
    ...
    },
    {
        ...
        title: 'The Perfect Pitch — Resume Workshop for Mid-Career Public Health Professionals Client',
    ...
    },
    {
        ...
        title: 'Learning Advisory at Amdocs Client',
    ...
    },
    {
        ...
        title: 'Corporate Recruitment Video Production Client',
    ...
    },
    {
        ...
        title: 'Content Strategy & Online Engagement Client',
    ...
    },
    {
        ...
        description: 'MEI Industrial Solutions had no internal pipeline for General Manager succession. When leadership vacancies arose, the organization defaulted to reactive external hiring. The ask: design a 24-month rotational training program from scratch to build the next generation of GMs from within.',
        background: 'lime',
        variant: 'desktop',
    ...
    },
    {
        ...
        title: 'Career Exploration & Restorative Justice Training Client',
    ...
    },
    {
        ...
        title: 'Capabilities Statement Client',
    ...
    },
    {
        ...
        description: 'The MEI employee responsible for managing worker access at the customer site left the company. No written process existed. Site access — including badging, SOW assignment, and customer-required training — was at risk of breaking down entirely.',
        background: 'lime',
        variant: 'desktop',
